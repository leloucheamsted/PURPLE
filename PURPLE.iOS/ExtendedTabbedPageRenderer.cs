...
namespace PURPLE.iOS
{
    public class ExtendedTabbedPageRenderer : TabbedRenderer
    {
        ...
        void AddFonts()
        {
            ...
            {
                TextColor = Color.FromHex("#43A3DB").ToUIColor(),
                Font = UIFont.FromName("AvenirNext-Regular", 12)
        ...
        private void UpdateTabBarItem(UITabBarItem item, string icon)
        {
            ...
            item.SetTitleTextAttributes(new UITextAttributes() { Font = UIFont.FromName("AvenirNext-DemiBold", 12), TextColor = Color.FromHex("#757575").ToUIColor() }, UIControlState.Normal);
            item.SetTitleTextAttributes(new UITextAttributes() { Font = UIFont.FromName("AvenirNext-DemiBold", 12), TextColor = Color.FromHex("#3C9BDF").ToUIColor() }, UIControlState.Selected);
        ...
        void AddSelectedTabIndicator()
        {
            ...
            {
                UITabBar.Appearance.SelectionIndicatorImage = GetImageWithColorPosition(Color.FromHex("#43A3DB").ToUIColor(), new CGSize(UIScreen.MainScreen.Bounds.Width / base.ViewControllers.Length, tabbedController.TabBar.Bounds.Size.Height + 4), new CGSize(UIScreen.MainScreen.Bounds.Width / base.ViewControllers.Length, 4));
            }
