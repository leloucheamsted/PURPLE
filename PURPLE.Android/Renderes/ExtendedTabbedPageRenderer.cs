...
namespace PURPLE.Droid
{
    public class ExtendedTabbedPageRenderer : TabbedPageRenderer
    {
        ...
        void ChangeFont()
        {
            var fontFace = Typeface.CreateFromAsset(Context.Assets, "AvenirNext-DemiBold.ttf");
        ...
        void BottomNavigationView_NavigationItemSelected(object sender, BottomNavigationView.ItemSelectedEventArgs e)
        {
            var bottomNavMenuView = bottomNavigationView.GetChildAt(0) as BottomNavigationMenuView;
        ...
        void SetupBottomNavigationView(IMenuItem item)
        {
            ...
            bottomLine.SetStroke(lineWidth, Xamarin.Forms.Color.FromHex("#43A3DB").ToAndroid());
